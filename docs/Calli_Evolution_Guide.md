# Calli Region — Evolution Guide

Calli uses a **1–20 level scale** instead of the usual 1–100. Here's the conversion used throughout this doc:
...
| Gloom → Bellossom | Sun Stone (alt. branch) |
...
| Aerodactyl | Does not evolve (Fossil revival) |
...
| Evolution | Method |
|---|---|
| Landorus, Thundurus, Tornadus, Heatran, Suicune, Celebi, Jirachi | None of these evolve |
