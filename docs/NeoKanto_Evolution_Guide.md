# Neo Kanto Evolution Guide

*Every evolution level below is converted from the source games' 1–100 scale onto Neo Kanto's compressed 1–20 scale, using the bucket table from* Dice_Region_Ruleset.md *§10:*
