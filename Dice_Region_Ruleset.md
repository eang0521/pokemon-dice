...
- [ ] (Optional) a "caught Pokémon" collection (shared localStorage key/shape), fed by a "Catch!"/"Save" button wherever a Pokémon is shown and readable back into either battle-sim side; EVs and attack type editable per entry, base stats locked same as elsewhere
